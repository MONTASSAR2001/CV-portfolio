...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Helix Collective — Personalized Medicine" },
      {
        name: "description",
        content:
          "A physician-scientist collective advancing personalized medicine through genomics, cellular engineering, and computational biology.",
      },
