    ...
    <div className="relative min-h-screen bg-background text-foreground overflow-hidden">
      ...
      >
        <div className="glass flex items-center gap-8 rounded-full px-6 py-3 text-sm">
          ...
          >
            KAI<span className="text-gradient-neon">.</span>
          </span>
      ...
      <section className="relative flex min-h-screen items-center justify-center px-6 pt-32">
        ...
        <div className="relative z-10 mx-auto max-w-5xl text-center">
          ...
          >
            Independent designer & developer crafting interactive experiences at the intersection of
            code, motion, and light.
          </motion.p>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
        ...
        >
          {Array.from({ length: 2 }).map((_, r) => (
            <div key={r} className="flex gap-16">
              {["Interaction Design", "◆", "Creative Development", "◆", "Motion", "◆", "Brand Systems", "◆", "3D & WebGL", "◆"].map(
                (t, i) => (
      ...
      <footer className="border-t border-white/10 px-6 py-8 text-xs text-white/40 md:px-16">
        <div className="mx-auto flex max-w-6xl items-center justify-between">
          <span>© 2026 Kai Nakamura Studio</span>
