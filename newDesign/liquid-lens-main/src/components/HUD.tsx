...
export function HUD() {
  ...
  return (
    <>
      ...
      {/* Bottom-left: name */}
      <div className="fixed bottom-8 left-12 z-50 mono text-[11px] tracking-[0.3em] text-white/60">
        <div className="text-white/40">DIRECTOR · DP</div>
        <div className="mt-1 text-white">A. VELA — STUDIO NOIR</div>
      </div>
