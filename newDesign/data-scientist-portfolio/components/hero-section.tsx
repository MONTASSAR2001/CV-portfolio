      ...
      <div className="relative z-10 mx-auto flex min-h-screen max-w-6xl flex-col justify-center px-6 pt-24">
        <div className="pointer-events-none max-w-2xl">
          ...
          <p className="mt-6 max-w-xl text-pretty text-base leading-relaxed text-muted-foreground md:text-lg">
            I&apos;m Aria Voss — a data scientist and growth engineer building machine-learning
            systems that move revenue. From churn models to multi-touch attribution, I ship
