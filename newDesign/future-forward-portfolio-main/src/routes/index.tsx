    ...
    <motion.div ref={ref} style={{ opacity }}
      ...
      <motion.div style={{ x }}
        ...
        <div className="mb-2 inline-flex items-center gap-2">
          ...
          {item.highlight && <span className="rounded-full bg-brand-orange/15 px-3 py-1 text-xs font-semibold text-brand-orange">Upcoming Defense</span>}
        </div>
    ...
    <div className="relative min-h-screen overflow-x-hidden">
      ...
      <nav className="relative z-20 mx-auto flex max-w-6xl items-center justify-between px-6 py-6">
        <div className="flex items-center gap-2 text-lg font-semibold">
          <span className="flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-brand text-white shadow-lg">Y</span>
          <span>Yassine.dev</span>
        </div>
      ...
      <section className="mx-auto grid max-w-6xl items-center gap-8 px-6 pt-8 pb-24 md:grid-cols-2 md:pt-16">
        <div className="relative z-10">
          ...
          <motion.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }}
            ...
            Telecom & electronics engineering student at the École Nationale d'Électronique et
            des Télécommunications de Sfax. Building embedded systems, AI projects, and — this
            summer — defending the <span className="font-semibold text-foreground">Smart Bella</span> robot.
          </motion.p>
      ...
      <section id="stack" className="relative mx-auto max-w-6xl px-6 py-24">
        ...
        <div className="relative flex min-h-[280px] flex-wrap items-center justify-center gap-4 rounded-3xl border border-white/60 bg-white/40 p-10 backdrop-blur-md">
          {stack.map((s, i) => <DraggableTag key={s} label={s} i={i} />)}
        </div>
      </section>
      ...
      <section id="contact" className="relative mx-auto max-w-4xl px-6 py-24 text-center">
        ...
        <div className="mt-8 flex justify-center gap-4">
          <a href="mailto:yassine@enetcom.tn" className="flex h-12 w-12 items-center justify-center rounded-full bg-white/80 shadow-md backdrop-blur transition hover:scale-110 hover:bg-gradient-brand hover:text-white">
            <Mail className="h-5 w-5" />
          </a>
          <a href="#" className="flex h-12 w-12 items-center justify-center rounded-full bg-white/80 shadow-md backdrop-blur transition hover:scale-110 hover:bg-gradient-brand hover:text-white">
        ...
        <p className="mt-16 text-xs text-muted-foreground">© 2026 · Built with curiosity in Sfax.</p>
      </section>
