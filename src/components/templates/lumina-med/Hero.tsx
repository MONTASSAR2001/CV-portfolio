        ...
        <div>
          ...
          >
            {data?.personalInfo?.name ? (
              <>
                Dr. {data.personalInfo.name} <br />
                <span className="text-gradient-azure italic">{data.personalInfo.role ?? "Specialist"}</span>
              </>
            ) : (
              <>
          ...
          >
            {data?.personalInfo?.bio ??
              "Two decades at the intersection of cardiothoracic surgery, regenerative science, and human-centered care. Fellow of the American College of Surgeons. Research faculty, Johns Hopkins."}
          </motion.p>
          <motion.div
