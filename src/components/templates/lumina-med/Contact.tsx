    ...
    <section id="contact" className="relative py-32 overflow-hidden bg-gradient-to-b from-background to-accent">
      <div className="mx-auto max-w-4xl px-6 text-center">
        ...
        <div className="mt-10 flex flex-wrap justify-center gap-4">
          <a href={`mailto:${data?.personalInfo?.email || "practice@vasari.md"}`} className="inline-flex items-center gap-2 rounded-full bg-gradient-to-br from-azure-deep to-azure px-7 py-3.5 text-sm text-primary-foreground shadow-glow">
            {data?.personalInfo?.email || "practice@vasari.md"}
          </a>
